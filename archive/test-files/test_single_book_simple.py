"""
Simple test of single book lecture generation
"""
import asyncio
import sys
...
async def test_oop_book():
    """Test OOP book specifically"""
    print("TESTING OOP BOOK")
    print("="*50)
    ...
    # Test TOC parsing first
    print("1. Testing TOC parsing...")
    data = pdf_processor.extract_text_from_pdf('ООП_на_питоне.pdf')
...
if __name__ == "__main__":
    success = asyncio.run(test_oop_book())
